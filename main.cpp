...
int main(int argc, char** argv) try {
    ...
    VIAM_SDK_LOG(info) << "Starting up sensors module";

    viam::sdk::Model model("38d7fa87-0f0f-44db-ab05-11f487e80997", "sensors", "mysensor");
    ...
    auto mr = std::make_shared<viam::sdk::ModelRegistration>(
        ...
        [](viam::sdk::Dependencies deps, viam::sdk::ResourceConfig cfg) {
            return std::make_unique<sensors::Mysensor>(deps, cfg);
        },
        &sensors::Mysensor::validate);
